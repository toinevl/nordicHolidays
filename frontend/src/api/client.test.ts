...
describe('apiClient.saveStopNote was removed — #173/#174', () => {
  beforeEach(() => vi.clearAllMocks())

  it('saveStopNote is no longer part of the API — notes use GET/POST/DELETE /api/itineraries/{id}/notes', () => {
    // The old PATCH-based note save was removed to eliminate last-write-wins.
    expect(apiClient.saveStopNote).toBeUndefined()
  })
})
